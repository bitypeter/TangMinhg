...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Hôm nay làm vợ buồn, vợ nghe thấy tiếng trái tim anh không? " + (thePercent+250) + " / 2 ";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = `
  Gương mặt giận dỗi của em, khi em giận anh đó ! <i class="fas fa-heart"></i><br>
  <img src="img/A1.jpg" alt="Gương mặt giận" width="200" style="margin-top: 10px; border-radius: 10px;">
`;
